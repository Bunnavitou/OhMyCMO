  ...
  return (
    <>
      ...
      <div className="space-y-4">
        <section className="card space-y-1.5 text-sm text-white/75">
          {partner.email && (
            <a href={`mailto:${partner.email}`} className="flex items-center gap-2">
              <Mail className="w-4 h-4 text-ash" /> {partner.email}
            </a>
          )}
          {partner.phone && (
            <a href={`tel:${partner.phone}`} className="flex items-center gap-2">
              <Phone className="w-4 h-4 text-ash" /> {partner.phone}
            </a>
          )}
        </section>
    ...
    <form onSubmit={submit} className="space-y-3">
      ...
      <div>
        ...
        <div className="relative">
          <DollarSign className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-ash" />
          <input
